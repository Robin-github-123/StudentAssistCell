...
function IconButton({
  ...
  return (
    <Link
      href={href}
      aria-label={label}
      className="rounded-xl p-2 text-white/90 transition hover:bg-white/10 hover:text-white flex items-center justify-center"
    >
      <span className="block w-5 h-5">{children}</span>
    </Link>
  );
}
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:gap-2">
            <span className="text-base sm:text-lg font-semibold text-cyan-300">KSU</span>
            <span className="text-xs sm:text-lg font-semibold text-white">Student Assist Cell</span>
          </div>
        </Link>
        ...
        <button
          ...
          className="md:hidden rounded-lg p-2 text-white/90 transition hover:bg-white/10"
        ...
        <div className="md:hidden border-t border-white/10 bg-slate-900/95 backdrop-blur">
          <nav className="mx-auto max-w-6xl px-4 py-4 space-y-2">
            ...
            <Link
              ...
              className={
                active === "home"
                  ? "block rounded-lg bg-blue-600/90 px-4 py-2 text-white shadow-md"
                  : "block rounded-lg px-4 py-2 text-white/80 hover:text-white hover:bg-white/10"
              }
            >
              Home
            </Link>
            ...
            <div className="grid grid-cols-2 gap-2 pt-2">
              <Link href="/" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 rounded-lg px-3 py-2 text-white/90 hover:bg-white/10">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
                  <path d="M11.47 2.97a.75.75 0 0 1 1.06 0l8.25 8.25a.75.75 0 1 1-1.06 1.06L20 11.56V19.5A2.25 2.25 0 0 1 17.75 21.75h-2.5a.25.25 0 0 1-.25-.25v-5a2.75 2.75 0 0 0-5.5 0v5a.25.25 0 0 1-.25.25h-2.5A2.25 2.25 0 0 1 4 19.5v-7.94l-.72.72a.75.75 0 1 1-1.06-1.06l8.25-8.25Z" />
                </svg>
              ...
              <Link href="#" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center gap-3 rounded-lg px-3 py-2 text-white/90 hover:bg-white/10">
                ...
                <span className="text-sm">Allotment</span>
              </Link>
